package com.example.madpractical11_20012011173
...
import com.example.madpractical11_20012011173.databinding.NoteItmeViewBinding

import java.io.Serializable

class NotesAdapter (private val context: Context, private val array:ArrayList<Note>):
    RecyclerView.Adapter<NotesAdapter.NotesViewHolder>() {
    inner class NotesViewHolder(val binding: NoteItmeViewBinding): RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NotesViewHolder {
        val binding = NoteItmeViewBinding.inflate(LayoutInflater.from(parent.context), parent, false)
